...
import { INode, TCheckFn } from '../../typings/node';

const traversal = <T extends INode>(condition: TCheckFn, node: INode, breakImmediate: boolean, result: T[]): T[] => {
 ...
 */
export const getNodesByCondition = <T extends INode>(condition: TCheckFn, node: INode, breakImmediate = false): T[] => {
