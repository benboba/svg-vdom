...
import { INode, IParentNode, ITextNode, TCheckFn } from '../../typings/node';
import { NodeType } from '../node/node-type';

const traversal = <T extends INode = IParentNode | ITextNode>(condition: TCheckFn, node: INode | IParentNode | ITextNode, breakImmediate: boolean, result: T[]): T[] => {
 ...
 */
export const getNodesByCondition = <T extends INode = IParentNode | ITextNode>(condition: TCheckFn, node: INode, breakImmediate = false): T[] => {
